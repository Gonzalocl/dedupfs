...
test=$(bin/test_file_get_block_hash bin/fs files 1 blocks 5 1 2 /test_file 0123456789abcdef9876543210fedcba 0 ccddccddccddccddccddccddccddccdd) || ( echo -e "${COLOR_ERR}$0 FAILED${COLOR_RESET}" && exit 1 )
ok="aabbaabbaabbaabbaabbaabbaabbaabb"
check "$test" "$ok"

test=$(bin/test_file_get_block_hash bin/fs files 1 blocks 5 1 2 /test_file 0123456789abcdef9876543210fedcba 1 ccddccddccddccddccddccddccddccdd) || ( echo -e "${COLOR_ERR}$0 FAILED${COLOR_RESET}" && exit 1 )
